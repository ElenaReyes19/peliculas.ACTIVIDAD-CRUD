...
<body>
<a href="${context}/views/peliculas/register.jsp" class="btn btn-outline-success"><i class="fas fa-plus"></i> Agregar usuario</a>
<table class="table">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <br>
                <h5>Descripcion:</h5>
                <label>Se hundio el barco</label>
                <br>
                <h5>Fecha de estreno:</h5>
                <label>01/01/1993</label>
                <br>
                <h5>Recaudacion:</h5>
                <label>1000000</label>
